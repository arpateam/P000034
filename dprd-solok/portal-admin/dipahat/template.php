...
<head>
    ...
    <!-- Plugins CSS-->
        ...
        <!-- Bantuan -->
        <?php elseif (($_GET['module']==="bantuan")): ?>
            ...
            <script>
                function confirmHapusBantuan(enkripsi) {
                    Swal.fire({
                        icon: 'warning',
                        ...
                        if (result.isConfirmed) {
                            window.location = "<?= $base_url_admin ?>/actionDeleteBantuan/" + enkripsi;
        ...
        <!-- Pengaturan -->
        <?php elseif (($_GET['module']=="pengaturan")): ?>
            <link href="<?= $base_url_admin ?>/assets/libs/dropzone/min/dropzone.min.css" rel="stylesheet" type="text/css" />
            <link href="<?= $base_url_admin ?>/assets/libs/dropify/css/dropify.min.css" rel="stylesheet" type="text/css" />
        <!-- End Pengaturan -->

        <!-- Data Penyakit, Data Gejala, Data Relasi, Data Solusi, Sitemap -->
        <?php elseif (($_GET['module']=="data-penyakit") OR ($_GET['module']=="data-gejala") OR ($_GET['module']=="data-relasi") OR ($_GET['module']=="data-solusi") OR ($_GET['module']=="sitemap")): ?>
        ...
        <!-- End Data Penyakit, Data Gejala, Data Relasi, Data Solusi, Sitemap -->
    ...
    <!-- Plugins js-->
        ...
        <?php elseif (($_GET['module']=="data-penyakit") OR ($_GET['module']=="data-gejala") OR ($_GET['module']=="data-relasi") OR ($_GET['module']=="data-solusi") OR ($_GET['module']=="sitemap")): ?>
            ...
            <script>
                ...
                function confirmHapusDataPenyakit(enkripsi) {
                    Swal.fire({
                        title: 'Apakah anda yakin ingin menghapus Data Penyakit ini?',
                        text: "Data yang telah terhapus tidak dapat dikembalikan lagi!",
                        showDenyButton: true,
                        confirmButtonText: 'Ya, Hapus Saja',
                        denyButtonText: 'Batal',
                        ...
                        /* Read more about isConfirmed, isDenied below */
                        if (result.isConfirmed) {
                            window.location = "actionDeleteDataPenyakit/" + enkripsi;
                        } else if (result.isDenied) {
                            Swal.fire('Data Penyakit tidak jadi di hapus', '', 'info')
                        }
                    })
                }
                function confirmHapusDataGejala(enkripsi) {
                    Swal.fire({
                        title: 'Apakah anda yakin ingin menghapus Data Gejala ini?',
                        text: "Data yang telah terhapus tidak dapat dikembalikan lagi!",
                        showDenyButton: true,
                        confirmButtonText: 'Ya, Hapus Saja',
                        denyButtonText: 'Batal',
                        ...
                        /* Read more about isConfirmed, isDenied below */
                        if (result.isConfirmed) {
                            window.location = "actionDeleteDataGejala/" + enkripsi;
                        } else if (result.isDenied) {
                            Swal.fire('Data Gejala tidak jadi di hapus', '', 'info')
                        }
                    })
                }
                function confirmHapusDataRelasi(enkripsi) {
                    Swal.fire({
                        title: 'Apakah anda yakin ingin menghapus Data Relasi ini?',
                        text: "Data yang telah terhapus tidak dapat dikembalikan lagi!",
                        showDenyButton: true,
                        confirmButtonText: 'Ya, Hapus Saja',
                        denyButtonText: 'Batal',
                        ...
                        /* Read more about isConfirmed, isDenied below */
                        if (result.isConfirmed) {
                            window.location = "actionDeleteDataRelasi/" + enkripsi;
                        } else if (result.isDenied) {
                            Swal.fire('Data Relasi tidak jadi di hapus', '', 'info')
                        }
                    })
                }
                function confirmHapusDataSolusi(enkripsi) {
                    Swal.fire({
                        title: 'Apakah anda yakin ingin menghapus Data Solusi ini?',
                        text: "Data yang telah terhapus tidak dapat dikembalikan lagi!",
                        showDenyButton: true,
                        confirmButtonText: 'Ya, Hapus Saja',
                        denyButtonText: 'Batal',
                        ...
                        /* Read more about isConfirmed, isDenied below */
                        if (result.isConfirmed) {
                            window.location = "actionDeleteDataSolusi/" + enkripsi;
                        } else if (result.isDenied) {
                            Swal.fire('Data Solusi tidak jadi di hapus', '', 'info')
                        }
                    })
                }
            </script>
        ...
        <!-- All Pages Sweet Alerts js -->
            ...
            <?php elseif ($_SESSION['_alert__']===2): ?>
                <script>
                    Swal.fire({ title: "Hai <?= $_SESSION['_nama__'] ?>, Selamat Datang di Ruang Kerja #ARPATEAM", text: "Jangan lupa semangat kerja untuk hari ini!", icon: "info" });
                </script>
